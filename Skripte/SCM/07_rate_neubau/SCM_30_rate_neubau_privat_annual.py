...
BASE_SCM  = BASE / "Auswertung" / "Causal inference" / "01_SCM_Bundesebene"
BASE_SPEC = BASE_SCM / "17__rate_neubau_privat_annual__2015-2022__vollerPool"
for sub in ("Data", "Tables", "Figures"):
    (BASE_SPEC / sub).mkdir(parents=True, exist_ok=True)

PANEL_E = BASE / "Auswertung" / "Panels" / "E_bundesland_panel_monthly.csv"
