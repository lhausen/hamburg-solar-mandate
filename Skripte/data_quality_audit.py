...
Computes:
  ...
  e) EEG-2023 boom — private installations 2023 vs. 2022 growth factor,
     computed twice:
       (i)  first-ring DiD sample (Panel D PLZs minus SECOND_RING from
...
SRC_MASTR = BASE / "Daten" / "Solardaten" / "mastr_solar_deutschland.csv"
SRC_D     = BASE / "Auswertung" / "Panels" / "D_did_panel_yearly.csv"
SRC_SH    = BASE / "Daten" / "Neubaudaten" / "Baufertigstellungen Gebäude SH Gemeinden 2000-2024.csv"
OUT       = BASE / "Auswertung" / "Berichte" / "01_data_quality_audit.txt"
...
# (i) first-ring DiD sample: Panel D PLZs minus SECOND_RING, treated vs. control
plz_d = (pd.read_csv(SRC_D, usecols=["Postleitzahl", "treated"], dtype={"Postleitzahl": str})
