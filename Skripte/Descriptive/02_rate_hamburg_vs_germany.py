...
Bundesland-level, Panel E (E_bundesland_panel_monthly.csv). Same rate
...
OUT  = BASE / "Auswertung" / "Descriptive Results" / "01_Statewide_Comparison" / "02_rate_hamburg_vs_germany.png"
