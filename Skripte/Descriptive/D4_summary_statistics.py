...
Unit: PLZ × year from D_did_panel_yearly.csv, first-ring sample — identical to
...
Output: Auswertung/Descriptive Results/D4_summary_statistics.png / .csv
...
OUT   = BASE / "Auswertung" / "Descriptive Results" / "D4_summary_statistics.png"
OUTC  = BASE / "Auswertung" / "Descriptive Results" / "D4_summary_statistics.csv"
OUT.parent.mkdir(parents=True, exist_ok=True)

CUTOFF = 2023

# ── Load DiD panel, first ring only ───────────────────────────────────────────
print("Loading Panel D …")
d = pd.read_csv(SRC_D)
...
fig.text(0.5, -0.06,
         ...
         "first-ring DiD panel (D_did_panel_yearly.csv, SECOND_RING excluded). Cells show "
