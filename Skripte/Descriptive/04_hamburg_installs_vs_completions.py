...
Grouped bar chart, Hamburg only, Panel E (E_bundesland_panel_monthly.csv).
...
OUT  = BASE / "Auswertung" / "Descriptive Results" / "02_Hamburg" / "04_hamburg_installs_vs_completions.png"
