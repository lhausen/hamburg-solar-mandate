...
not an arbitrary index. Area (flaeche_km2) comes from D_did_panel_yearly.csv,
...
OUT      = BASE / "Auswertung" / "Descriptive Results" / "03_Border_DiD_Comparison" / "07_border_parallel_trends.png"
