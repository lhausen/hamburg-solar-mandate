...
1,000, Panel E, Bundesland-level), but each series — Hamburg, every
...
SRC  = BASE / "Auswertung" / "Panels" / "E_bundesland_panel_monthly.csv"
OUT  = BASE / "Auswertung" / "Descriptive Results" / "01_Statewide_Comparison" / "03_rate_hamburg_vs_germany_indexed.png"
