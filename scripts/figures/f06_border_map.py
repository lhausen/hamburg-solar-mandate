...
Categories mirror the DiD panel exactly (Auswertung/Panels/B_did_panel_yearly.csv
...
GEO_HH     = BASE / "data/aux/postleitzahlen_json/de_hh_up_postleitzahlen_EPSG_4326.json"
GEO_SH     = BASE / "data/aux/postleitzahlen_json/schleswigholstein.geojson"
GEO_NI     = BASE / "data/aux/postleitzahlen_json/niedersachsen.geojson"
...
GEO_KREISE = BASE / "data/aux/postleitzahlen_json/K-2024-AI-S-03--AI2001--2026-06-02.geojson"
OUT     = BASE / "output" / "figures" / "f06_border_map.png"
...
EXCLUDED   = {"21039","22113","22145"}   # split PLZ, not in B_did_panel_yearly.csv
