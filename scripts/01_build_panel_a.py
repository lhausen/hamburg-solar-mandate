...
SRC         = BASE / "data" / "raw" / "mastr_solar_deutschland.csv"
...
for chunk in pd.read_csv(
    ...
    # 2026-08-27: capacity filter (> 0.8 kW) removed -- user decision; the
    # register's own balcony category (2961) remains the only device filter.
