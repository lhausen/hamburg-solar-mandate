...
border comparison (Panel B / B_did_panel_yearly.csv).
...
SINGLE SOURCE OF TRUTH for all border-comparison group membership:
  ...
  - TREATMENT / SH_CONTROL / NI_CONTROL : full lists (first + second ring),
    used by build_did_panel.py to construct Panel B
...
# ── Full group lists (first + second ring) — Panel B construction ────────────
