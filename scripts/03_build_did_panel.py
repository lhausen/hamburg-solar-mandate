...
Output: Auswertung/Panels/B_did_panel_yearly.csv
...
IN_PATH  = BASE / "data/panels/A_deutschland_plz_monat_operatortyp.csv"
IN_PATH = IN_PATH if IN_PATH.exists() else IN_PATH.with_suffix(".csv.gz")
PLZ_GEO  = BASE / "data/aux/PLZ_Gebiete_3575278427074611710.csv"
OUT_DIR  = BASE / "data/panels"
...
out_path = OUT_DIR / "B_did_panel_yearly.csv"
